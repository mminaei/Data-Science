...
# loading data from CSV file        
    ...
    def load_data(self):
        ...
        self.t = selected_production_data.loc[selected_production_data['CUM_DAYS']>self.skipped_days, 'CUM_DAYS'] - self.skipped_days
...
# preparation        
    ...
    def fit(self):
        ...
        t_cum = self.t.loc[(self.t>float(self.lower_limit_t.get())) & (self.t<float(self.upper_limit_t.get()))]
        q_cum = self.q_cum.loc[(self.t>float(self.lower_limit_t.get())) & (self.t<float(self.upper_limit_t.get()))]
